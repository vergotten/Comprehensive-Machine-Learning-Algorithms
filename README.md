...
- [Supervised Learning / Обучение с учителем](Supervised-Learning/README.md#supervised-learning)
  ...
  - [Classification / Классификация](Supervised-Learning/Classification)
    - [K-Nearest Neighbors (KNN) / K-ближайших соседей (KNN)](Supervised-Learning/README.md#k-nearest-neighbors-(knn))
    - [Support Vector Machines (SVM) / Метод опорных векторов (SVM)](Supervised-Learning/README.md#support-vector-machines-(svm))
    - [Naive Bayes / Наивный Байес](Supervised-Learning/README.md#naive-bayes)
    - [Decision Trees / Деревья решений](Supervised-Learning/README.md#decision-trees)
    - [Ensemble Methods / Ансамблевые методы](Supervised-Learning/README.md#decision-trees)
    - [Quadratic Discriminant Analysis (QDA) / Квадратичный дискриминантный анализ (QDA)](Supervised-Learning/README.md#decision-trees)
    - [Gradient Boosting Machines (GBM) / Машины градиентного бустинга (GBM)](Supervised-Learning/README.md#decision-trees)
    - [LightGBM](Supervised-Learning/README.md#decision-trees)
    - [CatBoost](Supervised-Learning/README.md#decision-trees)
